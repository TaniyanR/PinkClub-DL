...
$pageTitle = '作品一覧';
$pageDescription = 'DUGA作品一覧。並び替え・ページング対応。';
                            ...
                            <div class="product-card__body">
                                ...
                                <div class="product-card__actions">
                                    ...
                                    <?php if (!empty($item['affiliate_url'])) : ?>
                                        <a class="button button--primary" href="<?php echo e((string)$item['affiliate_url']); ?>" target="_blank" rel="noopener noreferrer sponsored nofollow">購入</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </article>
