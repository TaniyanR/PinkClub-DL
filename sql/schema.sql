...
CREATE TABLE IF NOT EXISTS duga_sites (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS duga_services (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_services_site FOREIGN KEY (site_code) REFERENCES duga_sites(site_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS duga_floors (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  ...
  CONSTRAINT fk_floor_service FOREIGN KEY (service_code) REFERENCES duga_services(service_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS actresses (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  duga_id VARCHAR(64) NOT NULL UNIQUE,
  name VARCHAR(255) NOT NULL,
...
ALTER TABLE genres MODIFY duga_id VARCHAR(64) NOT NULL UNIQUE;
CREATE TABLE IF NOT EXISTS makers LIKE actresses;
ALTER TABLE makers MODIFY duga_id VARCHAR(64) NOT NULL UNIQUE;
CREATE TABLE IF NOT EXISTS series_master LIKE actresses;
ALTER TABLE series_master MODIFY duga_id VARCHAR(64) NOT NULL UNIQUE;
CREATE TABLE IF NOT EXISTS authors LIKE actresses;
ALTER TABLE authors MODIFY duga_id VARCHAR(64) NOT NULL UNIQUE;
...
CREATE TABLE IF NOT EXISTS item_actresses (
  ...
  duga_id VARCHAR(64) NULL,
  actress_name VARCHAR(255) NOT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_item_actresses_duga_item (duga_id, item_id),
...
CREATE TABLE IF NOT EXISTS item_genres (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_item_genres_duga_item (duga_id, item_id),
...
CREATE TABLE IF NOT EXISTS item_makers (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY uk_item_maker (item_id, duga_id),
  INDEX idx_item_makers_duga_item (duga_id, item_id),
...
CREATE TABLE IF NOT EXISTS item_series (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY uk_item_series (item_id, duga_id),
  INDEX idx_item_series_duga_item (duga_id, item_id),
...
CREATE TABLE IF NOT EXISTS item_authors (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY uk_item_author (item_id, duga_id),
...
CREATE TABLE IF NOT EXISTS item_actors (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UNIQUE KEY uk_item_actor (item_id, duga_id),
